   ...
   <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <img src="dist/img/avatar.png" class="img-square elevation-3" style="width:30px;  border-radius:10%;" alt="User Image">        </div>
        <div class="info">
         ...
         <a href="#" style="color: #239db1; font-size: 15px"><i class="fa fa-circle text-primary" style="font-size: 13px;"></i> Project Manager</a>
        </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="management.php" class="nav-link">
             ...
             <li class="nav-item">
            <a href="memberassignment.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Member Assignment
              </p>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Project Update Data table</h3> 
